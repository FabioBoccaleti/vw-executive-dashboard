...
export const BRAND_CONFIGS: Record<Brand, BrandConfig> = {
  ...
  despesas_depto_vw: {
    id: 'despesas_depto_vw',
    name: 'Despesas por Departamento na Sorana VW',
    shortName: 'Desp. Depto VW',
    colors: {
      primary: '#0066b3',
      primaryHover: '#0052a3',
      primaryLight: '#e0f0ff',
  ...
  analise_evolutiva_despesas: {
    id: 'analise_evolutiva_despesas',
    name: 'Análise Evolutiva de Despesas',
    shortName: 'Análise Desp.',
    colors: {
      primary: '#0f766e',
      primaryHover: '#0d6660',
      primaryLight: '#ccfbf1',
      ...
      headerBg: 'bg-[#0f766e]',
      headerText: 'text-white',
      buttonBg: 'bg-[#0f766e] hover:bg-[#0d6660]',
      buttonText: 'text-white',
      badgeBg: 'bg-teal-100 dark:bg-teal-900/30',
      badgeText: 'text-teal-800 dark:text-teal-200',
    },
