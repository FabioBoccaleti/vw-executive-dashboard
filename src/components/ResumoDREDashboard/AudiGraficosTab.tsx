      ...
      <div className="p-2">
        {data.length === 0
          ...
          : <ResponsiveContainer width="100%" height={220}>
              <PieChart>
                <Pie data={data} dataKey="value" nameKey="name" cx="50%" cy="45%" innerRadius={50} outerRadius={85} paddingAngle={2}>
        ...
        <div className="flex gap-4">
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden flex-1">
            ...
            <div className="p-2">
              <ResponsiveContainer width="100%" height={220}>
                <PieChart>
                  <Pie data={despMes} dataKey="value" nameKey="name" cx="50%" cy="45%" innerRadius={50} outerRadius={85} paddingAngle={2}>
          ...
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden flex-1">
            ...
            <div className="p-2">
              <ResponsiveContainer width="100%" height={220}>
                <PieChart>
                  <Pie data={despAcum} dataKey="value" nameKey="name" cx="50%" cy="45%" innerRadius={50} outerRadius={85} paddingAngle={2}>
