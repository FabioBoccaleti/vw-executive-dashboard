...
import VendaProdutosDashboard from './VendaProdutosDashboard';
...
export default function VendasResultadoDashboard() {
  ...
  const [showVendaProdutos, setShowVendaProdutos] = useState(false);
    ...
    <div className="flex-1 flex flex-col" style={{ minHeight: 0 }}>
      ...
      <div className="bg-white border-b border-slate-200 px-6 flex gap-0 flex-shrink-0">
        {SUB_TABS.map(tab => (
          <button
            key={tab.id}
            onClick={() => { setActiveTab(tab.id); setShowPecas(false); setShowItemPecas(false); setShowServicos(false); setShowPecasSeg(false); setShowPecasML(false); setShowPecasEP(false); setShowVendaProdutos(false); }}
            className={`flex items-center gap-2 px-5 py-3 text-sm font-medium border-b-2 transition-colors ${
              !showPecas && !showItemPecas && !showServicos && !showPecasSeg && !showPecasML && !showPecasEP && !showVendaProdutos && activeTab === tab.id
        ...
        <button
          onClick={() => { setShowPecas(true); setShowItemPecas(false); setShowServicos(false); setShowPecasSeg(false); setShowPecasML(false); setShowPecasEP(false); setShowVendaProdutos(false); }}
          className={`flex items-center gap-2 px-5 py-3 text-sm font-medium border-b-2 transition-colors ${
            showPecas && !showPecasML && !showPecasEP && !showVendaProdutos
        ...
        <button
          onClick={() => { setShowItemPecas(true); setShowPecas(false); setShowServicos(false); setShowPecasSeg(false); setShowPecasML(false); setShowPecasEP(false); setShowVendaProdutos(false); }}
          className={`flex items-center gap-2 px-5 py-3 text-sm font-medium border-b-2 transition-colors ${
            showItemPecas
        ...
        <button
          onClick={() => { setShowServicos(true); setShowPecas(false); setShowItemPecas(false); setShowPecasSeg(false); setShowPecasML(false); setShowPecasEP(false); setShowVendaProdutos(false); }}
          className={`flex items-center gap-2 px-5 py-3 text-sm font-medium border-b-2 transition-colors ${
            showServicos
        ...
        <button
          onClick={() => { setShowPecasSeg(true); setShowPecas(false); setShowItemPecas(false); setShowServicos(false); setShowPecasML(false); setShowPecasEP(false); setShowVendaProdutos(false); }}
          className={`flex items-center gap-2 px-5 py-3 text-sm font-medium border-b-2 transition-colors ${
            showPecasSeg
              ? 'border-sky-500 text-sky-700 bg-sky-50/50'
              : 'border-transparent text-slate-500 hover:text-slate-700 hover:bg-slate-50'
        ...
        <button
          onClick={() => { setShowPecasML(true); setShowPecas(false); setShowItemPecas(false); setShowServicos(false); setShowPecasSeg(false); setShowPecasEP(false); setShowVendaProdutos(false); }}
          className={`flex items-center gap-2 px-5 py-3 text-sm font-medium border-b-2 transition-colors ${
            showPecasML
        ...
        <button
          onClick={() => { setShowPecasEP(true); setShowPecas(false); setShowItemPecas(false); setShowServicos(false); setShowPecasSeg(false); setShowPecasML(false); setShowVendaProdutos(false); }}
          className={`flex items-center gap-2 px-5 py-3 text-sm font-medium border-b-2 transition-colors ${
            showPecasEP
              ? 'border-teal-500 text-teal-700 bg-teal-50/50'
              : 'border-transparent text-slate-500 hover:text-slate-700 hover:bg-slate-50'
        ...
        <button
          onClick={() => { setShowVendaProdutos(true); setShowPecas(false); setShowItemPecas(false); setShowServicos(false); setShowPecasSeg(false); setShowPecasML(false); setShowPecasEP(false); }}
          className={`flex items-center gap-2 px-5 py-3 text-sm font-medium border-b-2 transition-colors ${
            showVendaProdutos
              ? 'border-violet-500 text-violet-700 bg-violet-50/50'
              : 'border-transparent text-slate-500 hover:text-slate-700 hover:bg-slate-50'
      ...
      {showVendaProdutos && <VendaProdutosDashboard />}
      {!showPecas && !showItemPecas && !showServicos && !showPecasSeg && !showPecasML && !showPecasEP && !showVendaProdutos && <>
      {/* Toolbar */}
