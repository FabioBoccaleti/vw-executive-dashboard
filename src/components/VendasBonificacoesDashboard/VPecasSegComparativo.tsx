      ...
      {!collapsed && <>
        ...
        <div className="grid grid-cols-2 xl:grid-cols-4 gap-3 mb-5">
          {slots.map((slot, idx) => {
            ...
            const nfs   = filterPeriod(allRows, slot).length;
            return (
          ...
          {slots.length < 4 && (
            <button
              onClick={addSlot}
              className="rounded-xl border-2 border-dashed border-slate-200 flex flex-col items-center justify-center gap-1.5 py-6 text-[11px] font-bold text-slate-400 hover:border-sky-400 hover:text-sky-600 transition-colors min-h-[120px]"
            >
