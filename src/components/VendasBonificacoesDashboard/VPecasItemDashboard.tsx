...
export function VPecasItemDashboard() {
  ...
  useEffect(() => {
    setLoading(true);
    loadVPecasItemRows().then(data => { setRows(data); setLoading(false); });
  }, []);
  ...
  async function handleAnnotationBlur() { await saveVPecasItemRows(rows); }
